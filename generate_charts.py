...
<body>
    <div class="title">Bilan Financier & Ventilation Budgétaire Optimisée</div>
    <div class="subtitle">Allocation des Dépenses Réduite (435 k€ / an - Temps Partagé 2,5j/sem) & Rentrée Nette Certifiée</div>
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <div class="card-val" style="color: #DC2626;">0,435 M€ / an</div>
            <div class="card-label">Reste à charge Métropole: ~217 k€ (50% UE)</div>
        </div>
        <div class="card">
            <div class="card-title">Bénéfice Net Public</div>
            <div class="card-val" style="color: #1E3A8A;">+2,065 M€ / an</div>
            <div class="card-label">Réinjectés dans le service public</div>
        </div>
    </div>
    
    <div class="alloc-title">Détail de l'Allocation du Budget IA (435 k€ / an)</div>
    <table class="alloc-table">
        ...
        <tbody>
            <tr>
                <td><strong>1. Licences Algorithmiques & Modèles Souverains</strong></td>
            ...
            <tr>
                <td><strong>3. Direction de Projet (Benoît SIGWALD - Temps Partagé 2,5j/sem)</strong></td>
                <td><strong>65 k€</strong></td>
                <td>14,9 %</td>
                <td>Direction de projet (2 à 3 jours/semaine), ingénierie et gestion des marchés.</td>
            </tr>
            <tr>
...
print("Graphique mis à jour avec budget AMO réduit (65 k€) et total 435 k€ généré avec succès !")
