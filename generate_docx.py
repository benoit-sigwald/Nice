...
# RÉSUMÉ EXÉCUTIF
# ---------------------------------------------------------
add_native_heading("Résumé Exécutif & Chiffrage Consolidé pour M. le Maire", 1, page_break=True)
...
add_native_heading("Ventilation du Coût Budgétaire IA par Allocation (435 k€ / an)", 2)
...
add_native_heading("1.1 Alignement Institutionnel & Leadership Métropolitain", 2)
...
add_native_heading("2.4 Consultation Directe par Quartier via l'IA Einstein", 2)
add_bullet("**Démocratie Participative Augmentée** : Déploiement de la plateforme de démocratie participative augmentée par l'**IA Einstein** pour consulter les Niçois quartier par quartier.")
...
# ---------------------------------------------------------
add_native_heading("3. Pôle 2 : Axe Métropole Nice Côte d'Azur (Budget, Cyber & Monaco)", 1, page_break=True)
...
add_native_heading("5.1 Présidence Éric Ciotti & Direction Benoît SIGWALD (2,5j/sem)", 2)
...
add_native_heading("5.3 Résumé Consolidé du Coût par Année Budgétaire", 2)
