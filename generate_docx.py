...
add_styled_heading("1.1 Alignement Institutionnel & Leadership Métropolitain", 2)
...
# ---------------------------------------------------------
add_styled_heading("2. Pôle 1 : Axe Ville de Nice (Sécurité & Cadre de Vie)", 1, page_break=True)
...
doc.save(docx_path)
print(f"Document Word/Google Docs avec puces systématiques et reformulation souple généré avec succès : {docx_path}")
