...
<body>
    ...
    <ul>
        ...
        <li><strong>6. AI Act Européen — Règlement (UE) 2024/1689 du 13 juin 2024** : Encadrement légal et labellisation des systèmes IA.</li>
...
print(f"PDF sans sous-section 1.3 redondante généré avec succès : {pdf_path}")
